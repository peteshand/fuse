	...
	public function play(frameIndex:Int):Void {
		...
		for (i in 0...len) {
			if (frames.length > i) {
				...
				var mouseEvent:MouseEvent = new MouseEvent(e.type, e.bubbles, e.cancelable, e.localX, e.localY, null, e.ctrlKey, e.altKey, e.shiftKey,
					e.buttonDown, e.delta, e.commandKey, e.clickCount);
