...
class Storage {
	...
	static function get_configSeedDirectory():File {
		init();
		return configSeedDirectory;
	}

	static function get_storageRootDir():File {
		init();
	...
	static function get_configDirectory():File {
		init();
		return configDirectory;
	}

	static function get_logDirectory():File {
		init();
		return logDirectory;
	}

	static function get_errorLogDirectory():File {
		init();
	...
	static function init():Void {
		...
		if (!errorLogDirectory.exists)
			errorLogDirectory.createDirectory();
	}
}
