...
@:keep #if display private #end class __ASSET__akkuratpro_otf extends lime.text.Font { public function new () { __fontPath = #if (ios || tvos) "assets/" + #end "akkuratpro.otf"; name = "Akkurat Pro Regular"; super (); }}
@:keep #if display private #end class __ASSET__arial_ttf extends lime.text.Font { public function new () { __fontPath = #if (ios || tvos) "assets/" + #end "arial.ttf"; name = "Arial"; super (); }}


#else

@:keep #if display private #end class __ASSET__akkuratpro_otf extends lime.text.Font { public function new () { #if !html5 __fontPath = "akkuratpro.otf"; #end name = "Akkurat Pro Regular"; super (); }}
@:keep #if display private #end class __ASSET__arial_ttf extends lime.text.Font { public function new () { #if !html5 __fontPath = "arial.ttf"; #end name = "Arial"; super (); }}
...
@:keep #if display private #end class __ASSET__OPENFL__akkuratpro_otf extends openfl.text.Font { public function new () { #if !html5 __fontPath = #if (ios || tvos) "assets/" + #end "akkuratpro.otf"; #end name = "Akkurat Pro Regular"; super (); }}
@:keep #if display private #end class __ASSET__OPENFL__arial_ttf extends openfl.text.Font { public function new () { #if !html5 __fontPath = #if (ios || tvos) "assets/" + #end "arial.ttf"; #end name = "Arial"; super (); }}
