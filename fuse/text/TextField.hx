...
class TextField extends Sprite {
	...
	override function get_height():Float
		return nativeTextField.height * this.scaleY;
	...
	function get_textWidth():Float
		return nativeTextField.textWidth * this.scaleX;
	...
	override function get_width():Float
		return nativeTextField.width * this.scaleX;
