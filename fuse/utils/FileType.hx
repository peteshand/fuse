...
class FileType
{
	...
	static public function dataType(url:String) 
	{
		...
		if (fileType == "jpg" || fileType == "jpeg" || fileType == "jpeg" || fileType == "jpeg") return DataType.IMAGE;
		else if (fileType == "mp4") return DataType.VIDEO;
		else if (fileType == "atf") return DataType.ATF;
		return null;
	}
}