...
class FrontBitmapTexture extends FrontBaseTexture {
	...
	public function new(bitmapData:BitmapData, ?width:Int, ?height:Int, queUpload:Bool = true,
		/*onTextureUploadCompleteCallback:Void -> Void = null, */ _textureId:Null<TextureId> = null,
