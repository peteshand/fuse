...
class Context3DBlendMode {
	...
	public static function init(context3D:Context3D) {
		...
		factors.set(BlendMode.MULTIPLY,
			{sourceFactor: Context3DBlendFactor.DESTINATION_COLOR, destinationFactor: Context3DBlendFactor.ONE_MINUS_SOURCE_ALPHA});
		...
		factors.set(BlendMode.BELOW,
			{sourceFactor: Context3DBlendFactor.ONE_MINUS_DESTINATION_ALPHA, destinationFactor: Context3DBlendFactor.DESTINATION_ALPHA});
