...
class WorkerDisplayData /*implements IDisplayData*/ {
	...
	inline function get_shaderId():Int {
		return memoryBlock.readInt(INDEX_SHADER_ID);
	}
	...
	inline function set_shaderId(value:Int):Int {
		memoryBlock.writeInt(INDEX_SHADER_ID, value);
		return value;
	}
