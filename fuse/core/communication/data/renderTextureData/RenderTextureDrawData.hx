...
class RenderTextureDrawData implements IRenderTextureDrawData {
	...
	static inline function set_OBJECT_POSITION(value:Int):Int {
		...
		RenderTextureDrawData._basePosition = Fuse.current.sharedMemory.renderTextureDrawDataPool.start
			+ (RenderTextureDrawData.OBJECT_POSITION * RenderTextureDrawData.BYTES_PER_ITEM);
		return value;
	}
