...
class WorkerBatchData implements IBatchData {
	...
	function get_renderTargetId():Int {
		return memoryBlock.readInt(RENDER_TARGET_ID);
	}

	function get_clearRenderTarget():Int {
		return memoryBlock.readInt16(CLEAR_RENDER_TARGET);
	}

	function get_startIndex():Int {
		return memoryBlock.readInt16(START_INDEX);
	}

	function get_blendMode():Int {
		return memoryBlock.readInt16(BLEND_MODE_INDEX);
	}

	function get_shaderId():Int {
		return memoryBlock.readInt16(SHADER_ID_INDEX);
	}

	function get_length():Int {
		return memoryBlock.readInt16(LENGTH_INDEX);
	}

	function get_textureId1():Int {
		return memoryBlock.readInt16(TEXTURE_ID1);
	}

	function get_textureId2():Int {
		return memoryBlock.readInt16(TEXTURE_ID2);
	}

	function get_textureId3():Int {
		return memoryBlock.readInt16(TEXTURE_ID3);
	}

	function get_textureId4():Int {
		return memoryBlock.readInt16(TEXTURE_ID4);
	}

	function get_textureId5():Int {
		return memoryBlock.readInt16(TEXTURE_ID5);
	}

	function get_textureId6():Int {
		return memoryBlock.readInt16(TEXTURE_ID6);
	}

	function get_textureId7():Int {
		return memoryBlock.readInt16(TEXTURE_ID7);
	}

	function get_textureId8():Int {
		return memoryBlock.readInt16(TEXTURE_ID8);
	}

	function get_numTextures():Int {
		return memoryBlock.readInt16(NUM_TEXTURES);
	}

	function get_numItems():Int {
		return memoryBlock.readInt16(NUM_ITEMS);
	}
	...
	function get_skip():Int {
		return memoryBlock.readInt16(SKIP);
	}
