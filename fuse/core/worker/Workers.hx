...
import fuse.core.worker.communication.WorkerlessComms;
import fuse.core.worker.thread.WorkerEntryPoint;
...
import fuse.core.worker.data.MessageType;
import fuse.core.worker.data.WorkerMessage;
