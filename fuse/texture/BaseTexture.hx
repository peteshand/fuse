...
class BaseTexture implements ITexture {
	...
	function get_objectId():ObjectId {
		return texture.objectId;
	}

	function get_textureId():TextureId {
		return texture.textureId;
	}

	function get_width():Null<Int> {
		return texture.width;
	}

	function get_height():Null<Int> {
		return texture.height;
	}

	function get_offsetU():Float {
		return texture.offsetU;
	}

	function get_offsetV():Float {
		return texture.offsetV;
	}
	...
	function get_directRender():Bool {
		return texture.directRender;
	}

	function get_textureData():ITextureData {
	...
	function get_clearColour():Color {
		return texture.clearColour;
	}

	function get__clear():Bool {
		return texture._clear;
	}

	function get__alreadyClear():Bool {
		return texture._alreadyClear;
	}
	...
	function set_width(value:Null<Int>):Null<Int> {
		return texture.width = value;
	}

	function set_height(value:Null<Int>):Null<Int> {
		return texture.height = value;
	}

	function set_offsetU(value:Float):Float {
		return texture.offsetU = value;
	}

	function set_offsetV(value:Float):Float {
		return texture.offsetV = value;
	}

	function set_scaleU(value:Float):Float {
		return texture.scaleU = value;
	}

	function set_scaleV(value:Float):Float {
		return texture.scaleV = value;
	}

	function set_directRender(value:Bool):Bool {
		return texture.directRender = value;
	}

	function set_textureData(value:ITextureData):ITextureData {
		return texture.textureData = value;
	}

	function set_clearColour(value:Color):Color {
		return texture.clearColour = value;
	}

	function set__clear(value:Bool):Bool {
		return texture._clear = value;
	}

	function set__alreadyClear(value:Bool):Bool {
		return texture._alreadyClear = value;
	}
	...
	public function addChangeListener(image:Image):Void {
		texture.addChangeListener(image);
	}

	public function removeChangeListener(image:Image):Void {
		texture.removeChangeListener(image);
	}
	...
	public static function fromTexture(texture:BaseTexture, region:Rectangle) {
		var offsetU:Float = region.x / texture.width;
		var offsetV:Float = region.y / texture.height;
		var scaleU:Float = region.width / texture.width;
		var scaleV:Float = region.height / texture.height;
		return texture.createSubTexture(offsetU, offsetV, scaleU, scaleV);
	}
}
