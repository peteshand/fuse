...
class TextFieldTexture extends BaseTexture {
	...
	public function getCharBoundaries(charIndex:Int):Rectangle {
		return textFieldTexture.getCharBoundaries(charIndex);
	}

	public function getCharIndexAtPoint(x:Float, y:Float):Int {
		return textFieldTexture.getCharIndexAtPoint(x, y);
	}

	public function getFirstCharInParagraph(charIndex:Int):Int {
		return textFieldTexture.getFirstCharInParagraph(charIndex);
	}

	public function getLineIndexAtPoint(x:Float, y:Float):Int {
		return textFieldTexture.getLineIndexAtPoint(x, y);
	}

	public function getLineIndexOfChar(charIndex:Int):Int {
		return textFieldTexture.getLineIndexOfChar(charIndex);
	}

	public function getLineLength(lineIndex:Int):Int {
		return textFieldTexture.getLineLength(lineIndex);
	}

	public function getLineMetrics(lineIndex:Int):TextLineMetrics {
		return textFieldTexture.getLineMetrics(lineIndex);
	}

	public function getLineOffset(lineIndex:Int):Int {
		return textFieldTexture.getLineOffset(lineIndex);
	}

	public function getLineText(lineIndex:Int):String {
		return textFieldTexture.getLineText(lineIndex);
	}

	public function getParagraphLength(charIndex:Int):Int {
		return textFieldTexture.getParagraphLength(charIndex);
	}

	public function getTextFormat(beginIndex:Int = 0, endIndex:Int = 0):TextFormat {
		return textFieldTexture.getTextFormat(beginIndex, endIndex);
	}
	...
	function get_antiAliasType():AntiAliasType
		return textFieldTexture.antiAliasType;

	function get_autoSize():TextFieldAutoSize
		return textFieldTexture.autoSize;

	function get_background():Bool
		return textFieldTexture.background;

	function get_backgroundColor():Int
		return textFieldTexture.backgroundColor;

	function get_border():Bool
		return textFieldTexture.border;

	function get_borderColor():Int
		return textFieldTexture.borderColor;

	function get_bottomScrollV():Int
		return textFieldTexture.bottomScrollV;

	function get_caretIndex():Int
		return textFieldTexture.caretIndex;

	function get_defaultTextFormat():TextFormat
		return textFieldTexture.defaultTextFormat;

	function get_displayAsPassword():Bool
		return textFieldTexture.displayAsPassword;

	function get_embedFonts():Bool
		return textFieldTexture.embedFonts;

	function get_gridFitType():GridFitType
		return textFieldTexture.gridFitType;

	function get_htmlText():String
		return textFieldTexture.htmlText;

	function get_length():Int
		return textFieldTexture.length;

	function get_maxChars():Int
		return textFieldTexture.maxChars;

	function get_maxScrollH():Int
		return textFieldTexture.maxScrollH;

	function get_maxScrollV():Int
		return textFieldTexture.maxScrollV;

	function get_mouseWheelEnabled():Bool
		return textFieldTexture.mouseWheelEnabled;

	function get_multiline():Bool
		return textFieldTexture.multiline;

	function get_numLines():Int
		return textFieldTexture.numLines;

	function get_restrict():String
		return textFieldTexture.restrict;

	function get_scrollH():Int
		return textFieldTexture.scrollH;

	function get_scrollV():Int
		return textFieldTexture.scrollV;

	function get_selectable():Bool
		return textFieldTexture.selectable;

	function get_selectionBeginIndex():Int
		return textFieldTexture.selectionBeginIndex;

	function get_selectionEndIndex():Int
		return textFieldTexture.selectionEndIndex;

	function get_sharpness():Float
		return textFieldTexture.sharpness;

	function get_text():String
		return textFieldTexture.text;

	function get_textColor():Int
		return textFieldTexture.textColor;

	function get_textWidth():Float
		return textFieldTexture.textWidth;

	function get_textHeight():Float
		return textFieldTexture.textHeight;

	function get_type():TextFieldType
		return textFieldTexture.type;

	function get_wordWrap():Bool
		return textFieldTexture.wordWrap;
