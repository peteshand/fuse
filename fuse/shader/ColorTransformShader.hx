...
class ColorTransformShader extends BaseShader {
	...
	function set_redMultiplier(value:Float):Float {
		colorTransform[0] = value;
		hasChanged = true;
		return value;
	}

	function set_greenMultiplier(value:Float):Float {
		colorTransform[1] = value;
		hasChanged = true;
		return value;
	}

	function set_blueMultiplier(value:Float):Float {
		colorTransform[2] = value;
		hasChanged = true;
		return value;
	}

	function set_alphaMultiplier(value:Float):Float {
	...
	function get_redOffset():Float {
		return colorTransform[4] * 0xFF;
	}

	function get_greenOffset():Float {
		return colorTransform[5] * 0xFF;
	}

	function get_blueOffset():Float {
		return colorTransform[6] * 0xFF;
	}

	function get_alphaOffset():Float {
		return colorTransform[7] * 0xFF;
	}

	function set_redOffset(value:Float):Float {
		colorTransform[4] = value / 0xFF;
		hasChanged = true;
		return value;
	}

	function set_greenOffset(value:Float):Float {
		colorTransform[5] = value / 0xFF;
		hasChanged = true;
		return value;
	}

	function set_blueOffset(value:Float):Float {
		colorTransform[6] = value / 0xFF;
		hasChanged = true;
		return value;
	}

	function set_alphaOffset(value:Float):Float {
		colorTransform[7] = value / 0xFF;
		hasChanged = true;
		return value;
	}
