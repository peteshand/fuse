...
class ColorTransformShader extends BaseShader
{
    ...
    function set_redOffset(value:Float):Float { colorTransform[4] = value; hasChanged = true; return value; }
    function set_greenOffset(value:Float):Float { colorTransform[5] = value; hasChanged = true; return value; }
    function set_blueOffset(value:Float):Float { colorTransform[6] = value; hasChanged = true; return value; }
    function set_alphaOffset(value:Float):Float { colorTransform[7] = value; hasChanged = true; return value; }
