...
class ParticleSystem extends Sprite {
	...
	private function set_emitterY(value:Float):Float {
		return _emitterY = value;
	}

	public var blendFactorSource(get, set):Context3DBlendFactor;

	private function get_blendFactorSource():Context3DBlendFactor {
	...
	private function get_blendFactorDestination():Context3DBlendFactor {
